...
import { Animated, StyleSheet, Text, View, Image, Easing, TouchableWithoutFeedback, ScrollView } from 'react-native';
        ...
        <View style={styles.main}>
          {(!this.state.drillDown) ?
            ...
            (<Animated.View style={{
              ...
              {stuff.map((e, i) => {
                return (
                  <TouchableWithoutFeedback key={i} style={styles.tapItem} onPress={(ev) => this.buttonClick(i)}>
