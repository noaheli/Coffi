...
export default class ShopListing extends Component {
  constructor(props) {
    super(props);
    this.state = {
      clicked: false,
            ...
            >
              {stuff.map((e, i) => {
                return (
                  <TouchableWithoutFeedback
                    key={i}
                    style={styles.tapItem}
                    onPress={(ev) => this.buttonClick(i)}
                  >
                      ...
                      <View style={styles.shopTitle}>
                        ...
                        <View style={styles.starBox}>
                          <Text style={styles.stars}>
                            <Icon name="star" size={12} color="#FFFF00" />{" "}
                            {stuff[i].stars}/5
                          </Text>
                        </View>
                      </View>
            ...
            >
              <ScrollView style={{ height: "100%", minHeight: "100%" }}>
                <View style={styles.ddTitleCard}>
                  ...
                  >
                    <TouchableWithoutFeedback
                      onPress={() => this.buttonClick(this.state.clickedIndex)}
                    >
                      <Text style={styles.shopTitleText}>
                        {stuff[this.state.clickedIndex].name}
                      </Text>
                    </TouchableWithoutFeedback>
                    <View style={{ ...styles.starBox }}>
                      <Text style={styles.stars}>
                        <Icon name="star" size={12} color="#FFFF00" />{" "}
                        {stuff[this.state.clickedIndex].stars}/5
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={{ ...styles.pwBox }}>
                    <View style={styles.infoBox}>
                      <View
                        style={{
                          ...styles.lockBox,
                          backgroundColor: stuff[this.state.clickedIndex]
                            .password.has
                            ? "#1BC458"
                            : "#FF4F6F",
                        }}
                    ...
                    <View style={styles.infoBox}>
                      ...
                      <View style={{ ...styles.wordBox }}>
                        <Text
                          ...
                          numberOfLines={1}
                        >
                          {stuff[this.state.clickedIndex].loc}
                        </Text>
                      </View>
                    </View>
                  </View>
