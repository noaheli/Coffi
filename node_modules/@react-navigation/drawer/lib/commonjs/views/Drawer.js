...
class DrawerView extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleTapStateChange", _reactNative.Platform.OS === 'web' ? // FIXME: Drawer doesn't close on Web with the same code that we use for native
    ({
      nativeEvent
    }) => {
      if (nativeEvent.state === _reactNativeGestureHandler.State.END && nativeEvent.oldState === _reactNativeGestureHandler.State.ACTIVE) {
